...
<div class="text-center text-success animateuse"   style="background-color: #40AFF8; font-size:25px;text-align:center; margin-top:-10px; padding-top:20px;">
      <img src ="img/cutlogoo.png" width="70"> <a style="color:white; font-weight:bold; font-size:30px;">   CUT SRC Fingerprint Voting System  </a>  <img src ="img/cutlogoo.png" width="70">
